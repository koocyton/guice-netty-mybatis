...
public class AccountController {
    ...
    @ResponseBody
    public User user(@RequestParam("userId") Long userId) {
        return helloService.hello(userId);
    }

    public String hello(ModelMap modelMap, @RequestParam("userId") Long userId) {
        User user = helloService.hello(userId);
